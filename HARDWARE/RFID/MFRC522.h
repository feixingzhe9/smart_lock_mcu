...
public:
  ...
  static const byte UNUSED_PIN = 0xFF;//UINT8_MAX.
	...
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_TransceiveData(byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits = 0, byte rxAlign = 0, bool checkCRC = false);
	StatusCode PCD_CommunicateWithPICC(byte command, byte waitIRq, byte *sendData, byte sendLen, byte *backData = 0, byte *backLen = 0, byte *validBits = 0, byte rxAlign = 0, bool checkCRC = false);
	...
	#else
	static const uint8_t *GetStatusCodeName(StatusCode code);
	static const uint8_t *PICC_GetTypeName(PICC_Type type);
	#endif

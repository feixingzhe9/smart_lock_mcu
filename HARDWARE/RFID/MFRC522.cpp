...
void MFRC522::PCD_Init() {
	...
	PCD_WriteRegister(ComIEnReg, 0xFF);
 ...
 */
const uint8_t *MFRC522::GetStatusCodeName(MFRC522::StatusCode code	///< One of the StatusCode enums.
										) {
 ...
 * @return const __FlashStringHelper *
 */
const uint8_t *MFRC522::PICC_GetTypeName(PICC_Type piccType	///< One of the PICC_Type enums.
													) {
...
void MFRC522::PCD_DumpVersionToSerial() {
	...
	switch(v) {
		case 0x88: /*Serial.println(F(" = (clone)")); */printf(" = (clone)");		break;
		case 0x90: /*Serial.println(F(" = v0.0")); */printf(" = v0.0");    break;
		case 0x91: /*Serial.println(F(" = v1.0"));*/ printf(" = v1.0");    break;
		case 0x92: /*Serial.println(F(" = v2.0"));*/printf(" = v2.0");     break;
		default:   /*Serial.println(F(" = (unknown)"));*/printf(" = (unknown)");
	}
	printf("\r\n");
